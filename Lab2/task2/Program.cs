...
namespace Task2
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            FileStream fs = new FileStream(@"C:\Users\PChelper\Desktop\qwerty\qwer\input.txt", FileMode.Open, FileAccess.Read);
            ...
            FileStream fs2 = new FileStream(@"C:\Users\PChelper\Desktop\qwerty\output.txt", FileMode.Create, FileAccess.Write);
